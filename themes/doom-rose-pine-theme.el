...
(def-doom-theme doom-rose-pine
  ...
  (
   ...
   ;; ediff
   (ediff-current-diff-A        :background (doom-blend love base 0.2) :foreground love)
   (ediff-current-diff-Ancestor :background region)
   (ediff-current-diff-B        :background (doom-blend foam base 0.2) :foreground foam)
   (ediff-current-diff-C        :background (doom-blend gold base 0.2) :foreground gold)
   (ediff-even-diff-A           :background overlay)
   (ediff-even-diff-Ancestor    :background overlay)
   (ediff-even-diff-B           :background overlay)
   (ediff-even-diff-C           :background overlay)
   (ediff-fine-diff-A           :background (doom-blend love base 0.4) :foreground love)
   (ediff-fine-diff-Ancestor    :background (doom-blend foam base 0.2) :foreground foam)
   (ediff-fine-diff-B           :background (doom-blend foam base 0.4) :foreground foam)
   (ediff-fine-diff-C           :background (doom-blend gold base 0.4) :foreground gold)
